...
function v = slog_dist_simpson1 ( x, ita, beta, gr, phi, n, nsigma ) 
  ...
  ig2 = 2 * slog_dist_integrand( zodd,  x, ita, beta, gr, phi );
  ig3 = 4 * slog_dist_integrand( zeven, x, ita, beta, gr, phi );
  v  = h/3 .* ( sum(ig2)+sum(ig3) );
endfunction
